...
$q="select count(*) \"total\" from registration WHERE username<>'admin'";
...
@$sq1="SELECT * from registration WHERE username<>'admin' limit $k,$dis";
...
<div style="margin-top:100px; margin-bottom:200px;">
  ...
  <form action="adminuserdelete.php" method="post" name="data_table">
...

{
  ...
  if($status==1)
    ...
    $statvalue="Unapproved";

?>

<tr>

  <td><?php echo $row1["registerid"]?></td>
  ...
  <td><font color="#000"><a href="adminuserstat.php?app_id=<?php echo $row1['registerid']?>"><?php echo $statvalue?></a></font></td>

  

 

  <td id="edit"><a href="adminuseredit.php?edit_id=<?php echo $row1['registerid']?>">Edit</td>

  <td id="edit">

  <input type="checkbox" value="<?php echo $row1['registerid']; ?>" name="data[]" id="data"></td>
...
if($page_cur>1)

  {
    ...
    echo '<a href="adminmanageuser.php?page='.($page_cur-1).'" style="cursor:pointer;color:silver;" ><input style="cursor:pointer;background-color:#00BFFF;border:1px black solid;border-radius:5px;width:120px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Previous "></a>';
...
for($i=1;$i<$total_page;$i++)

  {
    ...
    echo '<a href="adminmanageuser.php?page='.$i.'"> <input style="cursor:pointer;background-color:silver;border:1px black solid;border-radius:5px;width:30px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value="'.$i.'"> </a>';
...

  {
    ...
    echo '<a href="adminmanageuser.php?page='.($page_cur+1).'"><input style="cursor:pointer;background-color:#00BFFF;border:1px black solid;border-radius:5px;width:90px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Next "></a>';
