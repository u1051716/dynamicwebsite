...
<select name="category" style="width:145px;height:42px;">
...
<select name="subcategory" style="width:155px;height:42px;">
...
<input type="submit" value="Search" name="submit_search">
    ...
    if(isset($_POST['submit_search']))
    {
      ...
      $sql1="SELECT * from post WHERE catid='$category' AND subcatid='$subcategory' ORDER BY postid DESC";

        /*if($category=='post')
          $sql1="SELECT * from post WHERE postname LIKE'%$search%' ORDER BY postid DESC";
        if($category=='userid')
          $sql1="SELECT * from post WHERE userid='$search' ORDER BY postid DESC";
        if($category=='description')
          $sql1="SELECT * from post WHERE description LIKE'%$search%' ORDER BY postid DESC";*/

    }
   // $sql1="SELECT * from post WHERE userid='$_SESSION[userid]'";
    if(!isset($_POST['submit_search']))
    $sql1="SELECT * from post ORDER BY postid DESC LIMIT 0,10";
   ...
   <!-- <table>
    ...
    <table>
    <tr>
    <td><a href="upload/<?php echo $roo['imagename'];?>"><img src="upload/<?php echo $roo['imagename'];?>" width="60" height="60"></a></td>
    <td>
   ...
   // $sql1="SELECT * from post WHERE userid='$_SESSION[userid]'";
    ...
    { ?>
       ...
       <div class="box1">
		<table>
    <tr>
    <td class="align" style="padding-top: 25px;"><a href="upload/<?php echo $roo['imagename'];?>"><img class="img-circle" src="upload/<?php echo $roo['imagename'];?>" width="60" height="60"></a></td></tr>
   
  
<tr><td  class="align">
      Product: <?php echo $roo['postname'];?></td></tr>
...
<style type="text/css">
  .space{height: 3px;width: 100%;background: white;}
</style>
<div class="space"></div>
