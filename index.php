...
<span><i style="float:left;padding:10px;">Search By:</i> <?php 
...
<form method="post" action="search.php" style="margin-left:5px;margin-top:0px;">

 <!-- <input type="text" name="search" value="" placeholder="Search">-->

<select name="category" style="width:145px;height:42px;margin-left:300px;">
