...
$q="select count(*) \"total\" from post WHERE userid='$registerid'";
...
@$sq1="SELECT * from post WHERE userid='$registerid' limit $k,$dis";
...
<div style="margin-top:10px;">
  ...
  <form action="mydelete.php" method="post" name="data_table">
  ...
  <table border="1" id="table_data" style="border:4px solid deepSkyBlue; border-radius:10px;width:100%;text-align:center;">
    ...
    <th class="center">Check All <input type="checkbox" id="check_all" value=""></th>
...
if($page_cur>1)

  {
    ...
    echo '<a href="mymanagepost.php?page='.($page_cur-1).'" style="cursor:pointer;color:silver;" ><input style="cursor:pointer;background-color:#00BFFF;border:1px black solid;border-radius:5px;width:120px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Previous "></a>';
...
for($i=1;$i<$total_page;$i++)

  {
    ...
    echo '<a href="mymanagepost.php?page='.$i.'"> <input style="cursor:pointer;background-color:silver;border:1px black solid;border-radius:5px;width:30px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value="'.$i.'"> </a>';
...

  {
    ...
    echo '<a href="mymanagepost.php?page='.($page_cur+1).'"><input style="cursor:pointer;background-color:#00BFFF;border:1px black solid;border-radius:5px;width:90px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Next "></a>';
