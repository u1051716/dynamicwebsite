...
<section class="container1">
    ...
    <td class="align"  style="padding-top: 30px;"><a href="upload/<?php echo $roo['imagename'];?>"><img class="img-circle" src="upload/<?php echo $roo['imagename'];?>" width="60" height="60"></a></td></tr>
